# 👨‍💻 Lab Link: [Google Chat Bot - Apps Script - GSP250](https://www.cloudskillsboost.google/games/6064/labs/38615)
...
## Task 3. Replace code of `Code.gs` file
...
## Task 4. Replace code of `Code.gs` file
